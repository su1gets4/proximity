...
## Proximity 
Proximity is a reinforcement learning project seeking to push what can be done with AI in Trackmania as far as possible. 
...
Proximity uses the environment architecture of linesight RL
